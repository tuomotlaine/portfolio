    ...
    return(
      <RenderComputer renderChild={this.state.renderComputerCounter}>
        ...
        <div className="row" style={{marginTop: '24px'}}>
          <div className="col-xs-12">
            <TypeWriter speed={20} input="Professionally I would say that I am a generalist - someone who knows a little bit of everything. Look at this awesome ASCII chart to get an idea on which project phases I am most interested in:" onReady={this.renderComputer.bind(this)} />
          </div>
        </div>
        <div className="row" style={{marginTop: '24px'}}>
